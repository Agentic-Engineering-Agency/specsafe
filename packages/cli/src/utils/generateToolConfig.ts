...
`;
  ...
  async function createSkill(skillDirName: string, content: string): Promise<void> {
    ...
    if (!existsSync(skillPath)) {
      ...
      console.log(chalk.green(`✓ Created .claude/skills/${skillDirName}/SKILL.md`));
    } else {
      console.log(chalk.yellow(`⚠ .claude/skills/${skillDirName}/SKILL.md already exists, skipping`));
    }
  }
